...
public interface DatabaseManager {
	...
	/**
	 * Determines whether the database connection is using MySQL or SQLite. Will return
	 * true if MySQL is being used or false if SQLite is being used.
	 */
	boolean usingMySql();
	...
	/**
	 * Executes the requested resource from the sql directory in the resources folder. The
	 * resource will be retrieved from either the "mysql" or "sqlite" subdirectory based
	 * on which type of database this manager is connected to.
	 * 
	 * @param resourceName The resource which should be loaded and executed. The ".sql"
	...
	/**
	 * Executes the requested resource from the sql directory in the resources folder and
	 * returns the results of the query. The resource will be retrieved from either the
	 * "mysql" or "sqlite" subdirectory based on which type of database this manager is
	 * connected to.
	 * 
	 * @param resourceName The resource which should be loaded and executed. The ".sql"
	 *                     extension will be applied automatically.
	...
	/**
	 * Executes an SQL query on the database and returns any keys which have been generated
	 * for any autoincrementing values.
	 * 
	 * @param command The command to execute
	 * @param parameters The arguments that should be added in place of ?s in
	 *                   the statement before it is executed
	...
	/**
	 * Closes the {@link ResultSet} and any associated objects in order to free up
	 * used memory.
	 * 
	 ...
	 * by using the "update/&lt;revision&gt;/&lt;table&gt;_update" resources until
	 * the table is up-to-date.
	 * 
	 * @param tableName The name of the table that should be checked.
	 * @return True if the table is up-to-date or has been brought up-to-date. False
	 *         if the table failed to update or the table is at a higher revision
	 *         than GoldenApple.
	 */
