 ...
 * modules into memory, register permissions and commands, and perform other
 * module start-up tasks.
 * 
 * @author ben_dude56
 */
public abstract class ModuleLoader {
     ...
     * automatically.
     * 
     * @return True if the module will be automatically loaded, false if the
     * module must be manually loaded.
     */
     ...
     * module to load, false if the security policy prevents this module from
     * loading.
     */
