...
/**
 * Designed to provide an interface to manage and control GoldenApple's
 * various modules, this class will keep track of each module's
 * {@link ModuleLoader} and provide methods to enable/disable individual
 * modules. It will also handle module dependencies, crashes, and failures.
 *  
 * @author ben_dude56
 *
 */
public class SimpleModuleManager implements ModuleManager {
	...
	private static final String[]			loadOrder	= new String[] {
		"Base", "Permissions", "Lock", "Antigrief", "Chat", "Warp", "Punish", "Request", "Invisible", "Select", "Area" };
