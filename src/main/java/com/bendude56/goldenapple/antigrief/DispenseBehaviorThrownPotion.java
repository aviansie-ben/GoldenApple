...
import net.minecraft.server.v1_5_R1.DispenseBehaviorProjectile;
import net.minecraft.server.v1_5_R1.IPosition;
import net.minecraft.server.v1_5_R1.IProjectile;
