...
public class ItemPotion extends net.minecraft.server.v1_4_R1.ItemPotion {
	...
	public static void unregisterItem() throws Exception {
		Item.byId[Item.POTION.id] = null;
		Item potion = prepClass((Item)net.minecraft.server.v1_4_R1.ItemPotion.class.getConstructors()[0].newInstance(117));
