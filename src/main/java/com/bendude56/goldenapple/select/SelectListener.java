        ...
        if (SelectManager.getInstance().getSelectionProvider() instanceof SimpleSelectionProvider) {
            if (event.getItem() != null && event.getItem().getType() == Material.WOOD_AXE) {
                ...
                if (event.getAction() == Action.LEFT_CLICK_BLOCK) {
                    ...
                    user.sendLocalizedMessage("general.select.set1", l.getBlockX() + "", l.getBlockY() + "", l.getBlockZ() + "");
                    ...
                    user.sendLocalizedMessage("general.select.set2", l.getBlockX() + "", l.getBlockY() + "", l.getBlockZ() + "");
                    event.setCancelled(true);
                }
            }
        }
