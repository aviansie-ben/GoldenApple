...
public class ComplexArgumentParser {
	...
	public static class ArgumentInfo {
		...
		public ArgumentInfo(String argumentName, String shortSwitch, String longSwitch, ArgumentType type, boolean isList, boolean errorIfNotFound) {
		...
		public static ArgumentInfo newSwitch(String name, String shortSwitch, String longSwitch) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.SWITCH, false, false);
		}
		
		public static ArgumentInfo newString(String name, String shortSwitch, String longSwitch, boolean allowSpaces) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, (allowSpaces) ? ArgumentType.STRING_WITH_SPACES : ArgumentType.STRING, false, false);
		}
		
		public static ArgumentInfo newInt(String name, String shortSwitch, String longSwitch) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.INT, false, false);
		}
		
		public static ArgumentInfo newLong(String name, String shortSwitch, String longSwitch) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.LONG, false, false);
		}
		...
		public static ArgumentInfo newUser(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound, boolean mustBeOnline) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, (mustBeOnline) ? ArgumentType.USER_ONLINE : ArgumentType.USER, false, errorIfNotFound);
		}
		
		public static ArgumentInfo newGroup(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.GROUP, false, errorIfNotFound);
		}
		
		public static ArgumentInfo newWorld(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.WORLD, false, errorIfNotFound);
		}
		
		public static ArgumentInfo newStringList(String name, String shortSwitch, String longSwitch, boolean allowSpaces) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, (allowSpaces) ? ArgumentType.STRING_WITH_SPACES : ArgumentType.STRING, true, false);
		}
		
		public static ArgumentInfo newIntList(String name, String shortSwitch, String longSwitch) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.INT, true, false);
		}
		
		public static ArgumentInfo newLongList(String name, String shortSwitch, String longSwitch) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.LONG, true, false);
		}
		...
		public static ArgumentInfo newUserList(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound, boolean mustBeOnline) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, (mustBeOnline) ? ArgumentType.USER_ONLINE : ArgumentType.USER, true, errorIfNotFound);
		}
		
		public static ArgumentInfo newGroupList(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.GROUP, true, errorIfNotFound);
		}
		
		public static ArgumentInfo newWorldList(String name, String shortSwitch, String longSwitch, boolean errorIfNotFound) {
			return new ArgumentInfo(name, shortSwitch, longSwitch, ArgumentType.WORLD, true, errorIfNotFound);
		}

		public enum ArgumentType {
			SWITCH, STRING, STRING_WITH_SPACES, INT, LONG, USER, USER_ONLINE, GROUP, WORLD
		}
	}
}
