...
public class SimpleLockManager extends LockManager {
    static {
        ...
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.ACACIA_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.BIRCH_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.DARK_OAK_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.JUNGLE_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.SPRUCE_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_DOOR", GoldenApple.getInstance(), Material.WOODEN_DOOR, LockedDoor.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.ACACIA_FENCE_GATE, LockedFenceGate.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.BIRCH_FENCE_GATE, LockedFenceGate.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.DARK_OAK_FENCE_GATE, LockedFenceGate.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.FENCE_GATE, LockedFenceGate.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.JUNGLE_FENCE_GATE, LockedFenceGate.class);
        LockedBlock.registerBlock("GA_FENCEGATE", GoldenApple.getInstance(), Material.SPRUCE_FENCE_GATE, LockedFenceGate.class);
